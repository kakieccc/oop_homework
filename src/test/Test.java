...
public class Test extends TestCase {
	...
	public void test05() {
		try {
			...
			ArrayList<Activity> acts = (ArrayList<Activity>) asSystem.getActivitiesByDate(date);
			// 符合逻辑才能通过
	...
	public void test06() {
		try {
			...
			ArrayList<Team> teams = (ArrayList<Team>) stu.getTeamList();
